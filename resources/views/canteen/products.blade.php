                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="invoiceModalLabel">Invoice <p class="fw-semibold" style="font-size: 17px"><i><u>#{{ session('id') }}</u></i></p></h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <p class="fw-semibold text-uppercase" style="color: #959595">
                                                            <small>Detail Produk</small></p>
                                                        <p class="d-flex justify-content-between">
                                                            <span><strong>{{ \DB::table('products')->where('id', session('product_id'))->value('name') }}</strong></span>
                                                            <span>Rp. {{ number_format(\DB::table('products')->where('id', session('product_id'))->value('price')) }}</span>
                                                        </p>
                                                        <hr>
                                                        <p><strong>Quantity:</strong> {{ session('quantity') }} pcs</p>
                                                        <p><strong>Total Price:</strong> Rp.
                                                            {{ number_format(session('total_price'), 0, ',', '.') }}</p>
                                                        <p><strong>Status:</strong> <span class="text-uppercase badge bg-warning text-dark">{{ session('status') }}</span></p>
                                            ...
                                            <div class="input-group mb-3 d-flex justify-content-center">
                                                <div class="d-flex">
                                                    ...
                                                    <input type="number" name="quantity"
                                                        class="border-0 ms-2 text-center fw-semibold fs-4" value="1"
                                                        min="1" id="{{ $inputId }}" style="max-width: 55px;">
                                                </div>
